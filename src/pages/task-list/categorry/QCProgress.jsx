...
const QCProgress = ({redirect}) => {
  ...
  const filteredTodo = allTask?.filter((task) => task.status === "qc_progress");
    ...
    <>
      {isLoading ? (
        ...
        <section className="mt-[32px]">
          <StatusTitle className="bg-[#E9967A]"> QC Progress </StatusTitle>
                      ...
                      <tr>
                        ...
                        <td className="text-right px-2 whitespace-nowrap">
                          <div className="flex justify-between items-center px-5 w-full">
                            <StatusBtnOutLine className="text-[#E9967A]">
                              QC Progress
                            </StatusBtnOutLine>
