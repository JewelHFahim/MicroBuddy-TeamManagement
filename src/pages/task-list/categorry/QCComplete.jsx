...
const QCComplete = () => {
  ...
  const filteredTodo = allTask?.filter((task) => task.status === "qc_complete");
    ...
    <>
      {isLoading ? (
        ...
        <section className="mt-[32px]">
          <StatusTitle className="bg-[#4B0082]">QC Complete</StatusTitle>
                      ...
                      <tr>
                        ...
                        <td className="text-right px-2 whitespace-nowrap">
                          <div className="flex justify-between items-center px-5 w-full">
                            <StatusBtnOutLine className="text-[#4B0082]">
                              {" "}
                              QC Complete
                            </StatusBtnOutLine>
